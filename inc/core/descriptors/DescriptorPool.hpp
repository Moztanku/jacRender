/**
 * @file core/descriptors/DescriptorPool.hpp
...
public:
    ...
    ~DescriptorPool()
    {
        ...
        //         vulkan::FreeDescriptorSets(m_device, m_descriptorPool, 1, &descriptorSet);
        //     }
        // }

        if (m_descriptorPool != VK_NULL_HANDLE) {
            vulkan::DestroyDescriptorPool(m_device, m_descriptorPool, nullptr);
            m_descriptorPool = VK_NULL_HANDLE;
        }

        if (m_layout != VK_NULL_HANDLE) {
            vulkan::DestroyDescriptorSetLayout(m_device, m_layout, nullptr);
